...
Design of the turn-based RPG game dynamic.
Research and Development of all the media content that is going to be used on the game
Development of the turn-based RPG game.
Development of a backend database to storage the scores games using Firestore.
