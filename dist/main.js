...
class Game_Game extends phaser.Scene {
  ...
  create() {
    ...
    // const lastPlatform = this.findBottomMostPlatform()
    ...
    this.virusCollectedText = this.add.text(240, 10, 'Coronavirus: 0', style)
      .setScrollFactor(0)
      .setOrigin(0.5, 0);
  ...
  update() {
    ...
    if (this.player.y > bottomPlatform.y + 200) {
      window.score = this.virusCollected
...
/* harmony default export */ var src = __webpack_exports__["default"] = (new phaser.Game({
  ...
  width: 480,
  height: 640,
  scene: [Start_Start, Game_Game, GameOver_GameOver, RpgPlayer_RpgPlayer],
  parent: 'gameCont',
  physics: {
    default: 'arcade',
    arcade: {
